...
> GitNexus sử dụng [PolyForm Noncommercial License](https://github.com/abhigyanpatwari/GitNexus/blob/main/LICENSE). Repo này (chỉ chứa script, không chứa source GitNexus) sử dụng [MIT License](LICENSE).
...
| `rename` | Multi-file rename qua knowledge graph + text search | Rename symbol an toàn |
